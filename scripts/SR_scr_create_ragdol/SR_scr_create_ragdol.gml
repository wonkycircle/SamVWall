...
/// @param x
/// @param  y
function SR_scr_create_ragdol(argument0, argument1) {
	...
	var ha = sprite_get_height(SR_s_hand);
	...
	//bottle
	//ins15 = instance_create_depth(argument0 + tw/2 + ha*0.7 + ha*0.7, argument1 - th/2 + a1w/2, 0, SR_o_bottle);
	//ins15.phy_rotation = 180;
	...
	//bottle
	//j[14] = physics_joint_revolute_create(ins6, ins15, ins8.x, ins8.y, -90, 0, 1, 0, 0, 0, 0);
